...
test('summary CSV rows keep province, round, and bunch groups separate', () => {
  const entries = [
    { province_code: 'nakhon_pathom', round: 1, bunch: 1, quality: 10, below: 0, domestic: 0, damaged: 0, weight: 1.2, circum: 40 },
    { province_code: 'nakhon_pathom', round: 2, bunch: 1, quality: 1, below: 9, domestic: 0, damaged: 0, weight: 1.8, circum: 50 },
  ];
